...
/**
 * local time format: hours with optional minutes, seconds and fractions
 * valid: 9, 9:00, 9:30, 9:30:59, 9:30:59.843396
 */
export const hoursMinutesSecondsFractionsPattern =
